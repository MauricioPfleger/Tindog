...
namespace ListaTindog
{
    internal class Pet
    {
        ...
        public static string ToDisplayString(Object objeto)
        {
            if (objeto is Racas)
            {
                switch (objeto)
                {
                    ...
                    default:
                        ...
                        if (texto != null)
                            ...
                            throw new Exception("Nenhuma raça encontrada");
                }
            }
            else if (objeto is bool)
            {
                return (objeto.Equals(true)) ? "Sim" : "Não";
            }
            else
            {
                throw new Exception("Tipo de parâmetro não aceito");
            }
        }
    }
}
